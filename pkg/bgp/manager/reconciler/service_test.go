...
var (
	...
	redPeer65001v4LBRPName = PolicyStatementName("red-peer-65001", v2.BGPServiceAdvert, "red-svc-non-default-LoadBalancerIP")
	...
	redPeer65001Svc2v4LBRPName = PolicyStatementName("red-peer-65001", v2.BGPServiceAdvert, "red-svc2-non-default-LoadBalancerIP")
	...
	redPeer65001v6LBRPName = PolicyStatementName("red-peer-65001", v2.BGPServiceAdvert, "red-svc-non-default-LoadBalancerIP")
	...
	redPeer65001Svc2v6LBRPName = PolicyStatementName("red-peer-65001", v2.BGPServiceAdvert, "red-svc2-non-default-LoadBalancerIP")
	...
	redPeer65001v4ExtRPName = PolicyStatementName("red-peer-65001", v2.BGPServiceAdvert, "red-svc-non-default-ExternalIP")
	...
	redPeer65001v6ExtRPName = PolicyStatementName("red-peer-65001", v2.BGPServiceAdvert, "red-svc-non-default-ExternalIP")
	...
	redPeer65001v4ClusterRPName = PolicyStatementName("red-peer-65001", v2.BGPServiceAdvert, "red-svc-non-default-ClusterIP")
	...
	redPeer65001v6ClusterRPName = PolicyStatementName("red-peer-65001", v2.BGPServiceAdvert, "red-svc-non-default-ClusterIP")
...
func runServiceTests(t *testing.T, config option.BGPConfig, steps []svcTestStep) {
	...
	for _, tt := range steps {
		t.Run(tt.name, func(t *testing.T) {
			...
			requireDesiredRoutePolicies(
				t,
				f.db,
				f.svcReconciler.desiredRoutePolicyTable,
				testBGPInstance.Name,
				f.svcReconciler.Name(),
				tt.ExpectedRoutePolicies,
			)
