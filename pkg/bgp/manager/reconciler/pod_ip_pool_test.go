...
var (
	...
	redPeer65001v4PodIPPoolRPName = PolicyStatementName("red-peer-65001", v2.BGPCiliumPodIPPoolAdvert, redPoolName)
	...
	redPeer65001v6PodIPPoolRPName = PolicyStatementName("red-peer-65001", v2.BGPCiliumPodIPPoolAdvert, redPoolName)
	...
	bluePeer65001v4PodIPPoolRPName = PolicyStatementName("blue-peer-65001", v2.BGPCiliumPodIPPoolAdvert, bluePoolName)
	...
	bluePeer65001v6PodIPPoolRPName = PolicyStatementName("blue-peer-65001", v2.BGPCiliumPodIPPoolAdvert, bluePoolName)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			requireDesiredRoutePolicies(
				t,
				podIPPoolReconciler.db,
				podIPPoolReconciler.desiredRoutePolicyTable,
				testBGPInstance.Name,
				podIPPoolReconciler.Name(),
				tt.expectedRPs,
			)
		})
	}
